...
module.exports = function(client, page){
	...
	if (page > 0) {
		let kmess = 10;
		xsmb_cuoc.countDocuments({uid:client.UID}).exec(function(err, total){
			xsmb_cuoc.find({uid:client.UID}, {}, {sort:{'_id':-1}, skip: (page-1)*kmess, limit: kmess}, function(err, result) {
